...
HD_PWD='C:/Users/gomjellie/Documents/GitHub/Verilog/timer/timer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Timer.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Timer.tcl
