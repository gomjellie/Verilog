...
HD_PWD='C:/Users/gomjellie/Documents/GitHub/Verilog/timer/timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Timer.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Timer.tcl -notrace
