...
set rc [catch {
  ...
  set_property ip_repo_paths c:/Users/gomjellie/Documents/GitHub/Verilog/timer/timer.cache/ip [current_project]
  set_property ip_output_repo c:/Users/gomjellie/Documents/GitHub/Verilog/timer/timer.cache/ip [current_project]
  add_files -quiet C:/Users/gomjellie/Documents/GitHub/Verilog/timer/timer.runs/synth_1/Timer.dcp
  read_xdc C:/Users/gomjellie/Documents/GitHub/Verilog/timer/timer.srcs/constrs_1/new/timerXdc.xdc
  link_design -top Timer -part xc7z020clg484-1
  write_hwdef -file Timer.hwdef
...
set rc [catch {
  ...
  report_power -file Timer_power_routed.rpt -pb Timer_power_summary_routed.pb -rpx Timer_power_routed.rpx
