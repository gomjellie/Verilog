...
HD_PWD='C:/Users/gomjellie/Documents/GitHub/Verilog/LinearFeedbackShiftReg/LinearFeedbackShiftReg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LinearFeedbackShiftReg.vds -m64 -mode batch -messageDb vivado.pb -notrace -source LinearFeedbackShiftReg.tcl
