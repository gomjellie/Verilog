...
HD_PWD='C:/Users/gomjellie/Documents/GitHub/Verilog/LinearFeedbackShiftReg/LinearFeedbackShiftReg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LinearFeedbackShiftReg.vdi -applog -m64 -messageDb vivado.pb -mode batch -source LinearFeedbackShiftReg.tcl -notrace
